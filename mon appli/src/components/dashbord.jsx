...
.sidebar {
  ...
  box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);
        ...
        .task-progress, .funding-progress {
          margin-top: 0.75rem;
        }
        ...
        .kpis-card, .meetings-card, .evaluation-section, .activities-section {
          background: white;
          border-radius: 12px;
          padding: 1.5rem;
          box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05);
        ...
        .kpis-card h2, .meetings-card h2, .evaluation-section h2, .activities-section h2 {
          font-size: 1.25rem;
          color: #111827;
          margin-bottom: 1.5rem;
          font-weight: 600;
